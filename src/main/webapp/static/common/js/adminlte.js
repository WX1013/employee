...
+function ($) {
  ...
  Tree.prototype._setUpListeners = function () {
    ...
    $(this.element).on('click', this.options.trigger, function (event) {
    	if($($(this)[0].firstChild).hasClass("turn-page-click")){
  ...
  function mainMenuClickFunc(param) {
      ...
      var padd = $(this).parent('li').attr("data-flagadd");
      var pdel = $(this).parent('li').attr("data-flagdel");
      var pexport = $(this).parent('li').attr("data-flagexport");
      var pedit = $(this).parent('li').attr("data-flagedit");
      var pimport = $(this).parent('li').attr("data-flagimport");
      if(ajaxRequest){
    	  ajaxRequest.abort();
      }
      ajaxRequest = $.ajax({
